...
{	
	...
	public:
		static void Free(void* Ptr)
		{
            ...
            static void (*FMemoryFree)(void* Ptr) = decltype(FMemoryFree)(uintptr_t(GetModuleHandle(0)) + 0x54758F8);
		...
		static void* Realloc(void* Ptr, uint64 Size, uint32 Alignment)
		{
            ...
            static void* (*FMemoryRealloc)(void* Ptr, uint64 Size, uint32 Alignment) = decltype(FMemoryRealloc)(uintptr_t(GetModuleHandle(0)) + 0x1ADF5E4);
